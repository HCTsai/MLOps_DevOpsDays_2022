...
#
label_file_path = global_config.input_file_path
...
train_data_list = filetools.file_to_list(global_config.train_data_list)
test_data_list = filetools.file_to_list(global_config.test_data_list)
...
keyword_sentences = [s[0] for s in filetools.file_to_list("../config/swot/sys/SWOT.txt")]
...
feature_drift_model_name = global_config.feature_drift_model_name
