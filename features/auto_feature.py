...
# input
input_file_path = global_config.input_file_path
input_file_path_ext = global_config.input_file_path_ext
# output
...
def create_label_features(label_type, label_balance):
    ...
    write_label_feature(X_train,y_train, global_config.train_data_list)
    write_label_feature(X_test,y_test, global_config.test_data_list )
